...
| ⏳ Feedback | A spinner or progress bar wraps slow work during collection, animating on a TTY, honouring the colour/unicode switches, and degrading to a plain line when piped or headless | [feedback](https://phptui.dev/feedback) | [`15-feedback-*`](playground) |
