...
| [`05-headless/`](05-headless) | Unattended collection from a JSON payload and environment variables; the JSON schema, answer validation, generated agent help and folding it into a consumer's help. | `collect.php`, `schema.php`, `agent-help.php`, `agent-cli.php` |
