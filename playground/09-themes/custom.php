 ...
 *
 * OceanTheme.php beside this script subclasses DefaultTheme and overrides
 * appearance atoms and render methods. Naming the class on the facade is the
 * lowest-friction way to use it - no registration; options.php shows the
 * registered-alias route. The form also carries a start banner, shown before
 * the panels with the version underneath.
 *
 * Usage:
