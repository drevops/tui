 ...
 * 'border' are built-ins, 'accent' is declared by the AccentTheme beside this
 * script. Every value is validated against the theme's option schema, so a
 * typo throws at startup. The theme itself is registered under a short alias
 * with ThemeManager::register() - the third selection route besides a
 * built-in name and a class name (see custom.php).
 *
 * Usage:
