...
See [`playground/10-key-bindings`](https://github.com/drevops/tui/tree/main/playground/10-key-bindings) for the default map, the vim preset and a custom override side by side.
