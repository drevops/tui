...
Nesting, modal dialogs, both border looks and the fullscreen stretch are runnable in [`playground/03-panels/`](https://github.com/drevops/tui/tree/main/playground/03-panels), and inline editing in [`playground/04-inline-editing/`](https://github.com/drevops/tui/tree/main/playground/04-inline-editing).
