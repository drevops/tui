...
force a [display mode](/display-modes), `->fullscreen()` expands the frame to
the whole terminal (see [Fullscreen](/panels#fullscreen)), and `->translator()`
...
[`playground/06-form-logic/`](https://github.com/drevops/tui/tree/main/playground/06-form-logic).
