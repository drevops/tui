...
Derived values, conditional fields and fix-ups each have a runnable script in [`playground/06-form-logic/`](https://github.com/drevops/tui/tree/main/playground/06-form-logic).
