---
title: Translations
description: 'Present the TUI chrome and your questions in another language through layered catalogs, with plural rules and English fallback.'
keywords: ['translations', 'localization', 'i18n', 'catalogs', 'language']
---
