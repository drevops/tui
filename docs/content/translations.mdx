...
Translation is off by default. Turn it on by giving the form a `Translator` - the active language, and optionally the sources your own catalogs come from - the same way you set a theme or key map:
