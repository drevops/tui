...
<table>
  ...
  <tr>
    ...
    <td><img src="/widget-select-groups-dark-static.svg" alt="Select with groups: Unicode + ANSI" /></td>
    <td><img src="/widget-select-groups-dark-static-no-ansi.svg" alt="Select with groups: Unicode + No ANSI" /></td>
  </tr>
  <tr>
    <td align="right"><strong>ASCII</strong></td>
    <td><img src="/widget-select-groups-dark-static-ascii.svg" alt="Select with groups: ASCII + ANSI" /></td>
    <td><img src="/widget-select-groups-dark-static-ascii-no-ansi.svg" alt="Select with groups: ASCII + No ANSI" /></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="right"><strong>Unicode</strong></td>
    <td><img src="/widget-multiselect-groups-dark-static.svg" alt="MultiSelect with groups: Unicode + ANSI" /></td>
    <td><img src="/widget-multiselect-groups-dark-static-no-ansi.svg" alt="MultiSelect with groups: Unicode + No ANSI" /></td>
  </tr>
  <tr>
    <td align="right"><strong>ASCII</strong></td>
    <td><img src="/widget-multiselect-groups-dark-static-ascii.svg" alt="MultiSelect with groups: ASCII + ANSI" /></td>
    <td><img src="/widget-multiselect-groups-dark-static-ascii-no-ansi.svg" alt="MultiSelect with groups: ASCII + No ANSI" /></td>
  </tr>
</table>
