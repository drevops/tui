...
<p align="center">
  <img src="/widget-toggle-dark-animated.svg" alt="Toggle widget" />
</p>
...
<table>
  ...
  <tr>
    ...
    <td><img src="/widget-toggle-dark-static.svg" alt="Toggle: Unicode + ANSI" /></td>
    <td><img src="/widget-toggle-dark-static-no-ansi.svg" alt="Toggle: Unicode + No ANSI" /></td>
  </tr>
  <tr>
    <td align="right"><strong>ASCII</strong></td>
    <td><img src="/widget-toggle-dark-static-ascii.svg" alt="Toggle: ASCII + ANSI" /></td>
    <td><img src="/widget-toggle-dark-static-ascii-no-ansi.svg" alt="Toggle: ASCII + No ANSI" /></td>
  </tr>
</table>
