...
- 🤖 [**AI agents**](/ai-agents) - the form describes itself: `agentHelp()` hands back a plain-text driving guide and `schema()` a JSON schema to fold into your tool's help, so an agent can answer it unattended
