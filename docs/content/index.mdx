...
- 🤖 [**AI agents**](/ai-agents) - the form describes itself: a `--agent` flag prints a plain-text driving guide and `schema()` a JSON schema, so an agent can answer it unattended
